    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (resource.length() > 0) {
                boolean isStaticResource = resource.contains(".jsp") || resource.contains(".css") || uri.contains("/font/") || uri.contains("/images/") || resource.contains(".js");
                if (isStaticResource) {
                    url = resource;
                } else if (resource.equals("CreateTourController")) {
                    url = resource;
