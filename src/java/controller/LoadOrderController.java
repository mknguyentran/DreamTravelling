...
public class LoadOrderController extends HttpServlet {
    ...
    private static final Logger logger = Logger.getLogger(LoadOrderController.class);
    private static final String SUCCESS = "/user/orderHistory.jsp";
        ...
        try {
            ...
            if(account!=null){
                if(account.getRole().equals("user")){
                    ...
                    List<OrderDTO> orderList = oDAO.loadOrderHistory(userEmail);
